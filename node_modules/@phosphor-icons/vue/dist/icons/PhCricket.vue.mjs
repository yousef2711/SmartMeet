import { defineComponent as p, inject as s, computed as n, openBlock as t, createElementBlock as e, mergeProps as m, renderSlot as M, createCommentVNode as g, createElementVNode as o } from "vue";
const v = ["width", "height", "fill", "transform"], A = { key: 0 }, y = /* @__PURE__ */ o("path", { d: "M246.15,78.54,193.46,25.85a20,20,0,0,0-28.28,0L57.86,133.17a20,20,0,0,0,0,28.28l17.86,17.86-44.2,44.2a12,12,0,0,0,17,17l44.2-44.21,17.86,17.86a20,20,0,0,0,28.28,0L246.15,106.82A20,20,0,0,0,246.15,78.54ZM124.69,194.34l-15-15,26.83-26.83a12,12,0,0,0-17-17L92.69,162.34l-15-15L109,116h47v47ZM180,139V104a12,12,0,0,0-12-12H133l46.34-46.34,47,47ZM60,92A32,32,0,1,0,28,60,32,32,0,0,0,60,92Zm0-40a8,8,0,1,1-8,8A8,8,0,0,1,60,52Z" }, null, -1), f = [
  y
  ...
  setup(c) {
    const l = c, d = s("weight", "regular"), _ = s("size", "1em"), h = s("color", "currentColor"), u = s("mirrored", !1), a = n(() => l.weight ?? d), i = n(() => l.size ?? _), L = n(() => l.color ?? h), Z = n(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : u ? "scale(-1, 1)" : void 0);
    return (r, D) => (t(), e("svg", m({
      ...
      M(r.$slots, "default"),
      a.value === "bold" ? (t(), e("g", A, f)) : a.value === "duotone" ? (t(), e("g", w, V)) : a.value === "fill" ? (t(), e("g", x, S)) : a.value === "light" ? (t(), e("g", z, N)) : a.value === "regular" ? (t(), e("g", b, P)) : a.value === "thin" ? (t(), e("g", W, j)) : g("", !0)
    ], 16, v));
  }
});
export {
