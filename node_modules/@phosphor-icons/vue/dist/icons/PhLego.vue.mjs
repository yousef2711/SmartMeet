...
const g = ["width", "height", "fill", "transform"], C = { key: 0 }, L = /* @__PURE__ */ o("path", { d: "M245.36,77.28h0L203.74,56.45C201.38,40.24,183,28,160,28c-24.67,0-44,14.06-44,32a25,25,0,0,0,2.69,11.24l-9.4,4.7C101.56,71,91.35,68,80,68c-24.67,0-44,14.06-44,32a25,25,0,0,0,2.69,11.24l-28.06,14A12,12,0,0,0,4,136H4v56a12,12,0,0,0,6.63,10.73l64,32a12,12,0,0,0,10.74,0l160-80A12,12,0,0,0,252,144V88A12,12,0,0,0,245.36,77.28ZM80,154.58,42.83,136l15.81-7.9A58.2,58.2,0,0,0,80,132c24.67,0,44-14.06,44-32a25.39,25.39,0,0,0-.4-4.38l15-7.52A58.2,58.2,0,0,0,160,92c14.72,0,27.53-5,35.47-12.85L213.17,88ZM160,52c12.91,0,20,6,20,8s-7.09,8-20,8-20-6-20-8S147.09,52,160,52ZM80,92c12.91,0,20,6,20,8s-7.09,8-20,8-20-6-20-8S67.09,92,80,92ZM28,155.42l40,20v29.16l-40-20Zm64,49.16V175.42l136-68v29.16Z" }, null, -1), y = [
  ...
  setup(r) {
    const c = r, d = s("weight", "regular"), _ = s("size", "1em"), h = s("color", "currentColor"), Z = s("mirrored", !1), l = a(() => c.weight ?? d), n = a(() => c.size ?? _), v = a(() => c.color ?? h), M = a(() => c.mirrored !== void 0 ? c.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (i, D) => (t(), e("svg", u({
      ...
      p(i.$slots, "default"),
      l.value === "bold" ? (t(), e("g", C, y)) : l.value === "duotone" ? (t(), e("g", V, w)) : l.value === "fill" ? (t(), e("g", k, z)) : l.value === "light" ? (t(), e("g", B, b)) : l.value === "regular" ? (t(), e("g", E, W)) : l.value === "thin" ? (t(), e("g", $, H)) : m("", !0)
    ], 16, g));
  }
});
export {
