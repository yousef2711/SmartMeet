...
const Z = ["width", "height", "fill", "transform"], g = { key: 0 }, V = /* @__PURE__ */ e("path", { d: "M232.76,137.88A28.39,28.39,0,0,0,208.13,133L172,141.26c0-.42,0-.84,0-1.26a32,32,0,0,0-32-32H89.94a35.74,35.74,0,0,0-25.45,10.54L43,140H20A20,20,0,0,0,0,160v40a20,20,0,0,0,20,20H120a11.89,11.89,0,0,0,2.91-.36l64-16a11.4,11.4,0,0,0,1.79-.6l38.82-16.54c.23-.09.45-.19.67-.3a28.61,28.61,0,0,0,4.57-48.32ZM24,164H36v32H24Zm193.68.61-37.51,16L118.52,196H60V157l21.46-21.46A11.93,11.93,0,0,1,89.94,132H140a8,8,0,0,1,0,16H112a12,12,0,0,0,0,24h32a12.19,12.19,0,0,0,2.69-.3l67-15.41.47-.12a4.6,4.6,0,0,1,5.81,4.44A4.58,4.58,0,0,1,217.68,164.61ZM151.51,64.48a12,12,0,0,1,0-17l32-32a12,12,0,0,1,17,0l32,32a12,12,0,1,1-17,17L204,53v51a12,12,0,0,1-24,0V53L168.49,64.48A12,12,0,0,1,151.51,64.48Z" }, null, -1), M = [
  ...
  setup(c) {
    const l = c, d = s("weight", "regular"), h = s("size", "1em"), H = s("color", "currentColor"), _ = s("mirrored", !1), o = n(() => l.weight ?? d), i = n(() => l.size ?? h), u = n(() => l.color ?? H), L = n(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (r, q) => (a(), t("svg", A({
      ...
      v(r.$slots, "default"),
      o.value === "bold" ? (a(), t("g", g, M)) : o.value === "duotone" ? (a(), t("g", y, k)) : o.value === "fill" ? (a(), t("g", x, z)) : o.value === "light" ? (a(), t("g", C, N)) : o.value === "regular" ? (a(), t("g", b, P)) : o.value === "thin" ? (a(), t("g", W, j)) : m("", !0)
    ], 16, Z));
  }
});
export {
