import { defineComponent as L, inject as a, computed as Z, openBlock as l, createElementBlock as t, mergeProps as M, renderSlot as u, createCommentVNode as p, createElementVNode as e } from "vue";
const g = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ e("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm71.88,151.42h-24L166.1,158l11.3-32.94L193.15,120l18.6,14.26A83.42,83.42,0,0,1,199.88,171.42ZM44.25,134.21,62.85,120l15.75,5.11L89.9,158l-9.75,13.42h-24A83.42,83.42,0,0,1,44.25,134.21ZM111.85,148l-9.54-27.77L128,102.56l25.69,17.67L144.15,148Zm80.66-73.73-6.78,22.85-15.81,5.14L140,81.69V65.46l21.22-14.59A84.27,84.27,0,0,1,192.51,74.27ZM94.78,50.87,116,65.46V81.69L86.08,102.26,70.27,97.12,63.49,74.27A84.27,84.27,0,0,1,94.78,50.87Zm13.58,158.79-8.62-24.37L109.39,172h37.22l9.65,13.29-8.62,24.37a83.59,83.59,0,0,1-39.28,0Z" }, null, -1), V = [
  ...
  setup(i) {
    ...
    return (c, D) => (l(), t("svg", M({
      ...
      u(c.$slots, "default"),
      o.value === "bold" ? (l(), t("g", v, V)) : o.value === "duotone" ? (l(), t("g", H, k)) : o.value === "fill" ? (l(), t("g", S, C)) : o.value === "light" ? (l(), t("g", z, N)) : o.value === "regular" ? (l(), t("g", b, P)) : o.value === "thin" ? (l(), t("g", W, j)) : p("", !0)
    ], 16, g));
  }
});
export {
