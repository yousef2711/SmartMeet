import { defineComponent as M, inject as s, computed as n, openBlock as a, createElementBlock as t, mergeProps as v, renderSlot as m, createCommentVNode as u, createElementVNode as l } from "vue";
const p = ["width", "height", "fill", "transform"], V = { key: 0 }, g = /* @__PURE__ */ l("path", { d: "M228.88,113.61A60,60,0,0,0,166,33.42,60,60,0,0,0,65.1,47.83a60,60,0,0,0-38,94.56A60.08,60.08,0,0,0,83.6,223a57.83,57.83,0,0,0,6.45-.36A60,60,0,0,0,190.9,208.17a60,60,0,0,0,38-94.56ZM181.81,58.3a36,36,0,0,1,26.58,37.6L170,73.73a12,12,0,0,0-12,0L120,95.67V81.81L154.5,61.9A35.74,35.74,0,0,1,181.81,58.3ZM136,123.38v9.24l-8,4.62-8-4.62v-9.24l8-4.62ZM84,72a36,36,0,0,1,56.39-29.67L102,64.49a12,12,0,0,0-6,10.39v43.88l-12-6.93ZM44.33,88.93A35.81,35.81,0,0,1,60,74.43v44.33a12,12,0,0,0,6,10.4l38,21.93L92,158,57.5,138.1A36,36,0,0,1,44.33,88.93ZM74.19,197.7a36,36,0,0,1-26.58-37.6L86,182.27a12,12,0,0,0,12,0l38-21.94v13.86L101.5,194.1A35.74,35.74,0,0,1,74.19,197.7ZM172,184a36,36,0,0,1-56.39,29.67L154,191.51a12,12,0,0,0,6-10.39V137.24l12,6.93Zm39.67-16.93A35.81,35.81,0,0,1,196,181.57V137.24a12,12,0,0,0-6-10.4l-38-21.93L164,98l34.5,19.92A36,36,0,0,1,211.67,167.07Z" }, null, -1), y = [
  g
  ...
  setup(r) {
    const o = r, d = s("weight", "regular"), A = s("size", "1em"), Z = s("color", "currentColor"), _ = s("mirrored", !1), e = n(() => o.weight ?? d), c = n(() => o.size ?? A), h = n(() => o.color ?? Z), L = n(() => o.mirrored !== void 0 ? o.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (i, D) => (a(), t("svg", v({
      ...
      m(i.$slots, "default"),
      e.value === "bold" ? (a(), t("g", V, y)) : e.value === "duotone" ? (a(), t("g", f, C)) : e.value === "fill" ? (a(), t("g", x, z)) : e.value === "light" ? (a(), t("g", B, b)) : e.value === "regular" ? (a(), t("g", E, W)) : e.value === "thin" ? (a(), t("g", $, O)) : u("", !0)
    ], 16, p));
  }
});
export {
