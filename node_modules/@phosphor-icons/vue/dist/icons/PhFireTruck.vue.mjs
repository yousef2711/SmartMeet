import { defineComponent as m, inject as s, computed as h, openBlock as a, createElementBlock as t, mergeProps as A, renderSlot as v, createCommentVNode as M, createElementVNode as e } from "vue";
const u = ["width", "height", "fill", "transform"], p = { key: 0 }, g = /* @__PURE__ */ e("path", { d: "M255.14,115.54l-14-35A19.9,19.9,0,0,0,222.58,68H204V64a12,12,0,0,0-24,0v94.06A36.23,36.23,0,0,0,158.06,180H113.94a36,36,0,0,0-67.88,0H36V144a12,12,0,0,0-24,0v40a20,20,0,0,0,20,20H46.06a36,36,0,0,0,67.88,0h44.12a36,36,0,0,0,67.88,0H236a20,20,0,0,0,20-20V120A12,12,0,0,0,255.14,115.54ZM219.88,92l6.4,16H204V92ZM80,204a12,12,0,1,1,12-12A12,12,0,0,1,80,204Zm112,0a12,12,0,1,1,12-12A12,12,0,0,1,192,204Zm33.94-24A36.23,36.23,0,0,0,204,158.06V132h28v48ZM24,92a12,12,0,0,0,0,24H152a12,12,0,0,0,0-24H140V76h12a12,12,0,0,0,0-24H24a12,12,0,0,0,0,24H36V92Zm92,0H100V76h16ZM60,76H76V92H60Z" }, null, -1), y = [
  g
  ...
  setup(i) {
    const H = i, r = s("weight", "regular"), V = s("size", "1em"), c = s("color", "currentColor"), d = s("mirrored", !1), o = h(() => H.weight ?? r), l = h(() => H.size ?? V), Z = h(() => H.color ?? c), _ = h(() => H.mirrored !== void 0 ? H.mirrored ? "scale(-1, 1)" : void 0 : d ? "scale(-1, 1)" : void 0);
    return (n, T) => (a(), t("svg", A({
      ...
      v(n.$slots, "default"),
      o.value === "bold" ? (a(), t("g", p, y)) : o.value === "duotone" ? (a(), t("g", f, x)) : o.value === "fill" ? (a(), t("g", S, C)) : o.value === "light" ? (a(), t("g", B, b)) : o.value === "regular" ? (a(), t("g", E, P)) : o.value === "thin" ? (a(), t("g", W, j)) : M("", !0)
    ], 16, u));
  }
});
export {
