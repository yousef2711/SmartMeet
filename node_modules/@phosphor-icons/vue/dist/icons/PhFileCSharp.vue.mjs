import { defineComponent as Z, inject as s, computed as v, openBlock as a, createElementBlock as t, mergeProps as u, renderSlot as H, createCommentVNode as p, createElementVNode as e } from "vue";
const A = ["width", "height", "fill", "transform"], g = { key: 0 }, M = /* @__PURE__ */ e("path", { d: "M216.49,79.51l-56-56A12,12,0,0,0,152,20H56A20,20,0,0,0,36,40v68a12,12,0,0,0,24,0V44h76V92a12,12,0,0,0,12,12h48V224a12,12,0,0,0,24,0V88A12,12,0,0,0,216.49,79.51ZM160,57l23,23H160ZM40,180c0,8.67,5.5,16,12,16a10.27,10.27,0,0,0,7.33-3.43,12,12,0,1,1,17.34,16.6A34,34,0,0,1,52,220c-19.85,0-36-17.94-36-40s16.15-40,36-40a34,34,0,0,1,24.67,10.83,12,12,0,1,1-17.34,16.6A10.27,10.27,0,0,0,52,164C45.5,164,40,171.33,40,180Zm132-8a12,12,0,0,0,0-24h-4v-4a12,12,0,0,0-24,0v4H132v-4a12,12,0,0,0-24,0v4h-4a12,12,0,0,0,0,24h4v12h-4a12,12,0,0,0,0,24h4v4a12,12,0,0,0,24,0v-4h12v4a12,12,0,0,0,24,0v-4h4a12,12,0,0,0,0-24h-4V172Zm-28,12H132V172h12Z" }, null, -1), y = [
  M
  ...
  setup(c) {
    const o = c, i = s("weight", "regular"), r = s("size", "1em"), d = s("color", "currentColor"), _ = s("mirrored", !1), h = v(() => o.weight ?? i), l = v(() => o.size ?? r), V = v(() => o.color ?? d), m = v(() => o.mirrored !== void 0 ? o.mirrored ? "scale(-1, 1)" : void 0 : _ ? "scale(-1, 1)" : void 0);
    return (n, q) => (a(), t("svg", u({
      ...
      H(n.$slots, "default"),
      h.value === "bold" ? (a(), t("g", g, y)) : h.value === "duotone" ? (a(), t("g", f, k)) : h.value === "fill" ? (a(), t("g", S, z)) : h.value === "light" ? (a(), t("g", L, N)) : h.value === "regular" ? (a(), t("g", b, P)) : h.value === "thin" ? (a(), t("g", W, j)) : p("", !0)
    ], 16, A));
  }
});
export {
