...
const L = ["width", "height", "fill", "transform"], M = { key: 0 }, V = /* @__PURE__ */ o("path", { d: "M152,84a36,36,0,1,0-36-36A36,36,0,0,0,152,84Zm0-48a12,12,0,1,1-12,12A12,12,0,0,1,152,36Zm52,108v88a12,12,0,0,1-24,0V155.24c-24.92-3.37-33.94-17.29-41.38-28.76-1.55-2.39-3.05-4.71-4.67-6.88l-9.54,22L159,166.23a12,12,0,0,1,5,9.77v56a12,12,0,0,1-24,0V182.17l-25.37-18.12L83,236.78a12,12,0,1,1-22-9.57L118.52,94.9A12,12,0,0,1,135,89a45.53,45.53,0,0,1,8.84,6c6.78,5.89,11.09,12.53,14.89,18.39C166.27,125,170.8,132,192,132A12,12,0,0,1,204,144ZM64.6,153.88,39.27,143A12,12,0,0,1,33,127.27l24-56A12,12,0,0,1,72.73,65L98.34,76A12,12,0,1,1,88.89,98L74.3,91.76,59.76,125.7l14.29,6.12a12,12,0,1,1-9.45,22.06Z" }, null, -1), y = [
  ...
  setup(r) {
    const l = r, d = s("weight", "regular"), _ = s("size", "1em"), h = s("color", "currentColor"), A = s("mirrored", !1), a = n(() => l.weight ?? d), c = n(() => l.size ?? _), m = n(() => l.color ?? h), u = n(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : A ? "scale(-1, 1)" : void 0);
    return (i, D) => (t(), e("svg", Z({
      ...
      v(i.$slots, "default"),
      a.value === "bold" ? (t(), e("g", M, y)) : a.value === "duotone" ? (t(), e("g", f, C)) : a.value === "fill" ? (t(), e("g", S, z)) : a.value === "light" ? (t(), e("g", B, P)) : a.value === "regular" ? (t(), e("g", b, W)) : a.value === "thin" ? (t(), e("g", $, H)) : g("", !0)
    ], 16, L));
  }
});
export {
