import { defineComponent as u, inject as s, computed as c, openBlock as t, createElementBlock as e, mergeProps as p, renderSlot as g, createCommentVNode as Z, createElementVNode as a } from "vue";
const v = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ a("path", { d: "M132,72a12,12,0,0,1,12-12h43L175.51,48.49a12,12,0,1,1,17-17l32,32a12,12,0,0,1,0,17l-32,32a12,12,0,0,1-17-17L187,84H144A12,12,0,0,1,132,72Zm95.84,111.58A60.26,60.26,0,0,1,168,236C86.39,236,20,169.61,20,88A60.26,60.26,0,0,1,72.42,28.16,20,20,0,0,1,93.2,40l21.11,47.13.07.18a19.93,19.93,0,0,1-1.65,18.83,10.67,10.67,0,0,1-.85,1.15L92.82,130c7.06,12.84,20.5,26.16,33.49,33.21l22.31-19a11.68,11.68,0,0,1,1.12-.84,19.92,19.92,0,0,1,19-1.74l.18.08L216,162.8A20,20,0,0,1,227.84,183.58Zm-24.31-.06-42-18.81-22.42,19.07a11.77,11.77,0,0,1-1.12.85,20,20,0,0,1-19.7,1.41c-19.48-9.4-38.89-28.68-48.31-48a20,20,0,0,1,1.28-19.64,10.75,10.75,0,0,1,.86-1.15L91.3,94.5l-18.82-42A36.27,36.27,0,0,0,44,88,124.15,124.15,0,0,0,168,212,36.27,36.27,0,0,0,203.53,183.52Z" }, null, -1), w = [
  f
  ...
  setup(r) {
    const l = r, h = s("weight", "regular"), d = s("size", "1em"), _ = s("color", "currentColor"), A = s("mirrored", !1), o = c(() => l.weight ?? h), n = c(() => l.size ?? d), L = c(() => l.color ?? _), m = c(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : A ? "scale(-1, 1)" : void 0);
    return (i, q) => (t(), e("svg", p({
      ...
      g(i.$slots, "default"),
      o.value === "bold" ? (t(), e("g", y, w)) : o.value === "duotone" ? (t(), e("g", C, x)) : o.value === "fill" ? (t(), e("g", H, z)) : o.value === "light" ? (t(), e("g", B, P)) : o.value === "regular" ? (t(), e("g", b, V)) : o.value === "thin" ? (t(), e("g", W, j)) : Z("", !0)
    ], 16, v));
  }
});
export {
