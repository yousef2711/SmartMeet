...
const v = ["width", "height", "fill", "transform"], y = { key: 0 }, M = /* @__PURE__ */ e("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm0,192a84,84,0,1,1,84-84A84.09,84.09,0,0,1,128,212ZM76,108a16,16,0,1,1,16,16A16,16,0,0,1,76,108Zm72,0a16,16,0,1,1,16,16A16,16,0,0,1,148,108Zm30.92,64.94a12,12,0,0,1-16.78,2.52,38.18,38.18,0,0,1-7.74-8.26,35.12,35.12,0,0,0-2.4-3,35.12,35.12,0,0,0-2.4,3C146,172,140,180,128,180s-18-8-21.6-12.8a35.12,35.12,0,0,0-2.4-3,35.12,35.12,0,0,0-2.4,3,38.18,38.18,0,0,1-7.74,8.26,12,12,0,0,1-14.27-19.3,22.82,22.82,0,0,0,2.81-3.36C86,148,92,140,104,140s18,8,21.6,12.8a35.12,35.12,0,0,0,2.4,3,35.12,35.12,0,0,0,2.4-3C134,148,140,140,152,140s18,8,21.6,12.8a22.82,22.82,0,0,0,2.81,3.36A12,12,0,0,1,178.92,172.94Z" }, null, -1), f = [
  ...
  setup(r) {
    const c = r, d = a("weight", "regular"), _ = a("size", "1em"), h = a("color", "currentColor"), m = a("mirrored", !1), o = n(() => c.weight ?? d), i = n(() => c.size ?? _), u = n(() => c.color ?? h), Z = n(() => c.mirrored !== void 0 ? c.mirrored ? "scale(-1, 1)" : void 0 : m ? "scale(-1, 1)" : void 0);
    return (l, G) => (t(), s("svg", p({
      ...
      C(l.$slots, "default"),
      o.value === "bold" ? (t(), s("g", y, f)) : o.value === "duotone" ? (t(), s("g", w, x)) : o.value === "fill" ? (t(), s("g", z, N)) : o.value === "light" ? (t(), s("g", b, P)) : o.value === "regular" ? (t(), s("g", V, $)) : o.value === "thin" ? (t(), s("g", j, D)) : g("", !0)
    ], 16, v));
  }
});
export {
