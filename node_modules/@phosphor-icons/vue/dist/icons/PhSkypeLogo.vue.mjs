import { defineComponent as A, inject as c, computed as n, openBlock as t, createElementBlock as e, mergeProps as g, renderSlot as C, createCommentVNode as Z, createElementVNode as o } from "vue";
const v = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ o("path", { d: "M172,152c0,20.19-19.33,36-44,36-21.26,0-39.46-12.35-43.27-29.38a12,12,0,0,1,23.42-5.24C109.3,158.49,117.21,164,128,164c9.44,0,20-5.13,20-12,0-6.37-6.29-9.32-24-14.42-16.14-4.65-38.23-11-38.23-33.58,0-20.52,18.15-36,42.22-36,17.24,0,32.06,8.14,38.69,21.24a12,12,0,1,1-21.41,10.84C142.8,95.17,136,92,128,92c-10.22,0-18.22,5.27-18.22,12,0,1.09,0,2.21,3.28,4.17,4.18,2.48,11,4.45,17.6,6.35,8.75,2.52,17.8,5.13,25.38,9.86C169.23,132.61,172,143.94,172,152Zm64,24a60.07,60.07,0,0,1-60,60A59.36,59.36,0,0,1,144,226.73,101.21,101.21,0,0,1,128,228,100.11,100.11,0,0,1,28,128a101.21,101.21,0,0,1,1.27-16A59.36,59.36,0,0,1,20,80,60.07,60.07,0,0,1,80,20a59.36,59.36,0,0,1,32.05,9.27A101.21,101.21,0,0,1,128,28,100.11,100.11,0,0,1,228,128,101.21,101.21,0,0,1,226.73,144,59.36,59.36,0,0,1,236,176Zm-24,0a35.63,35.63,0,0,0-7.49-22,12,12,0,0,1-2.23-9.87,76.07,76.07,0,0,0-90.43-90.43A12,12,0,0,1,102,51.49,35.63,35.63,0,0,0,80,44,36,36,0,0,0,44,80a35.63,35.63,0,0,0,7.49,22,12,12,0,0,1,2.23,9.87,76.07,76.07,0,0,0,90.43,90.43,12,12,0,0,1,9.87,2.23A35.63,35.63,0,0,0,176,212,36,36,0,0,0,212,176Z" }, null, -1), w = [
  f
  ...
  setup(r) {
    ...
    return (l, F) => (t(), e("svg", g({
      ...
      C(l.$slots, "default"),
      s.value === "bold" ? (t(), e("g", y, w)) : s.value === "duotone" ? (t(), e("g", M, x)) : s.value === "fill" ? (t(), e("g", z, N)) : s.value === "light" ? (t(), e("g", b, P)) : s.value === "regular" ? (t(), e("g", V, $)) : s.value === "thin" ? (t(), e("g", j, q)) : Z("", !0)
    ], 16, v));
  }
});
export {
