...
const g = ["width", "height", "fill", "transform"], A = { key: 0 }, C = /* @__PURE__ */ s("path", { d: "M92,24C68.45,24,52,43.74,52,72s16.45,48,40,48,40-19.74,40-48S115.55,24,92,24Zm0,72C76.45,96,76,74.46,76,72s.45-24,16-24,16,21.54,16,24S107.55,96,92,96Zm53.27-42.63a12,12,0,0,1,5.36-16.1l24-12A12,12,0,0,1,192,36v72a12,12,0,0,1-24,0V55.42l-6.63,3.31A12,12,0,0,1,145.27,53.37ZM164,136c-23.55,0-40,19.74-40,48s16.45,48,40,48,40-19.74,40-48S187.55,136,164,136Zm0,72c-15.55,0-16-21.54-16-24s.45-24,16-24,16,21.54,16,24S179.55,208,164,208Zm-60-60v72a12,12,0,0,1-24,0V167.42l-6.63,3.31a12,12,0,1,1-10.74-21.46l24-12A12,12,0,0,1,104,148Z" }, null, -1), V = [
  ...
  setup(r) {
    const l = r, d = c("weight", "regular"), _ = c("size", "1em"), h = c("color", "currentColor"), Z = c("mirrored", !1), o = a(() => l.weight ?? d), n = a(() => l.size ?? _), m = a(() => l.color ?? h), u = a(() => l.mirrored !== void 0 ? l.mirrored ? "scale(-1, 1)" : void 0 : Z ? "scale(-1, 1)" : void 0);
    return (i, D) => (t(), e("svg", p({
      ...
      v(i.$slots, "default"),
      o.value === "bold" ? (t(), e("g", A, V)) : o.value === "duotone" ? (t(), e("g", y, k)) : o.value === "fill" ? (t(), e("g", x, B)) : o.value === "light" ? (t(), e("g", H, b)) : o.value === "regular" ? (t(), e("g", E, P)) : o.value === "thin" ? (t(), e("g", W, j)) : M("", !0)
    ], 16, g));
  }
});
export {
