...
const Z = ["width", "height", "fill", "transform"], H = { key: 0 }, L = /* @__PURE__ */ o("path", { d: "M222.33,106.79,212,103.35V56a20,20,0,0,0-20-20H140V24a12,12,0,0,0-24,0V36H64A20,20,0,0,0,44,56v47.35l-10.33,3.44a20,20,0,0,0-13.67,19V152c0,64.63,100.8,90.57,105.09,91.64a11.94,11.94,0,0,0,5.82,0C135.2,242.57,236,216.63,236,152V125.77A20,20,0,0,0,222.33,106.79ZM68,60H188V95.35L131.79,76.62a11.85,11.85,0,0,0-7.58,0L68,95.35Zm144,92c0,36.69-58.08,60.43-84,67.59-25.94-7.17-84-30.9-84-67.59V128.65l72-24V168a12,12,0,0,0,24,0V104.65l72,24Z" }, null, -1), y = [
  ...
  setup(r) {
    const s = r, d = l("weight", "regular"), V = l("size", "1em"), _ = l("color", "currentColor"), h = l("mirrored", !1), a = n(() => s.weight ?? d), c = n(() => s.size ?? V), u = n(() => s.color ?? _), p = n(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : h ? "scale(-1, 1)" : void 0);
    return (i, D) => (t(), e("svg", v({
      ...
      g(i.$slots, "default"),
      a.value === "bold" ? (t(), e("g", H, y)) : a.value === "duotone" ? (t(), e("g", M, w)) : a.value === "fill" ? (t(), e("g", k, S)) : a.value === "light" ? (t(), e("g", z, N)) : a.value === "regular" ? (t(), e("g", b, P)) : a.value === "thin" ? (t(), e("g", W, j)) : A("", !0)
    ], 16, Z));
  }
});
export {
