import { defineComponent as u, inject as H, computed as s, openBlock as a, createElementBlock as t, mergeProps as p, renderSlot as g, createCommentVNode as v, createElementVNode as e } from "vue";
const M = ["width", "height", "fill", "transform"], y = { key: 0 }, f = /* @__PURE__ */ e("path", { d: "M80,108a12,12,0,0,1-12,12H28a12,12,0,0,1,0-24H68A12,12,0,0,1,80,108ZM68,136H28a12,12,0,0,0,0,24H68a12,12,0,0,0,0-24Zm0,40H28a12,12,0,0,0,0,24H68a12,12,0,0,0,0-24Zm80-40H108a12,12,0,0,0,0,24h40a12,12,0,0,0,0-24Zm0,40H108a12,12,0,0,0,0,24h40a12,12,0,0,0,0-24Zm40-96h40a12,12,0,0,0,0-24H188a12,12,0,0,0,0,24Zm40,16H188a12,12,0,0,0,0,24h40a12,12,0,0,0,0-24Zm0,40H188a12,12,0,0,0,0,24h40a12,12,0,0,0,0-24Zm0,40H188a12,12,0,0,0,0,24h40a12,12,0,0,0,0-24Z" }, null, -1), w = [
  f
], A = { key: 1 }, k = /* @__PURE__ */ e("path", {
  d: "M232,64V192H24V80A16,16,0,0,1,40,64Z",
  opacity: "0.2"
}, null, -1), V = /* @__PURE__ */ e("path", { d: "M80,96a8,8,0,0,1-8,8H24a8,8,0,0,1,0-16H72A8,8,0,0,1,80,96Zm-8,24H24a8,8,0,0,0,0,16H72a8,8,0,0,0,0-16Zm0,32H24a8,8,0,0,0,0,16H72a8,8,0,0,0,0-16Zm0,32H24a8,8,0,0,0,0,16H72a8,8,0,0,0,0-16Zm80-64H104a8,8,0,0,0,0,16h48a8,8,0,0,0,0-16Zm0,32H104a8,8,0,0,0,0,16h48a8,8,0,0,0,0-16Zm0,32H104a8,8,0,0,0,0,16h48a8,8,0,0,0,0-16Zm80-96H184a8,8,0,0,0,0,16h48a8,8,0,0,0,0-16ZM184,72h48a8,8,0,0,0,0-16H184a8,8,0,0,0,0,16Zm48,48H184a8,8,0,0,0,0,16h48a8,8,0,0,0,0-16Zm0,32H184a8,8,0,0,0,0,16h48a8,8,0,0,0,0-16Zm0,32H184a8,8,0,0,0,0,16h48a8,8,0,0,0,0-16Z" }, null, -1), x = [
  k,
  V
  ...
  setup(Z) {
    ...
    return (n, F) => (a(), t("svg", p({
      ...
      g(n.$slots, "default"),
      o.value === "bold" ? (a(), t("g", y, w)) : o.value === "duotone" ? (a(), t("g", A, x)) : o.value === "fill" ? (a(), t("g", z, C)) : o.value === "light" ? (a(), t("g", B, N)) : o.value === "regular" ? (a(), t("g", b, W)) : o.value === "thin" ? (a(), t("g", $, q)) : v("", !0)
    ], 16, M));
  }
});
export {
