import { defineComponent as A, inject as n, computed as i, openBlock as t, createElementBlock as e, mergeProps as Z, renderSlot as g, createCommentVNode as M, createElementVNode as o } from "vue";
const C = ["width", "height", "fill", "transform"], v = { key: 0 }, y = /* @__PURE__ */ o("path", { d: "M128,20A108,108,0,1,0,236,128,108.12,108.12,0,0,0,128,20Zm84,107.86c-.56,1.41-5.7,7.11-22.88,12.33a157.26,157.26,0,0,1-17.57,4.15c.3-5.44.45-10.91.45-16.34,0-27.85-3.95-56.83-12.25-77.75A84.13,84.13,0,0,1,212,127.86ZM127.86,44c1.41.56,7.11,5.7,12.33,22.88,5,16.6,7.81,38.31,7.81,61.12,0,6.56-.24,13-.68,19.32-6.29.44-12.76.68-19.32.68-22.81,0-44.52-2.78-61.12-7.81C49.7,135,44.56,129.27,44,127.86A84.1,84.1,0,0,1,127.86,44ZM50.25,159.75C71.17,168.05,100.15,172,128,172c5.43,0,10.9-.15,16.34-.46a156.93,156.93,0,0,1-4.15,17.58C135,206.3,129.27,211.44,127.86,212A84.13,84.13,0,0,1,50.25,159.75Zm109.5,46c4.19-10.57,7.28-23.2,9.3-36.7,13.5-2,26.13-5.11,36.7-9.3A84.42,84.42,0,0,1,159.75,205.75Z" }, null, -1), f = [
  ...
  setup(d) {
    const s = d, a = n("weight", "regular"), _ = n("size", "1em"), h = n("color", "currentColor"), u = n("mirrored", !1), c = i(() => s.weight ?? a), l = i(() => s.size ?? _), m = i(() => s.color ?? h), p = i(() => s.mirrored !== void 0 ? s.mirrored ? "scale(-1, 1)" : void 0 : u ? "scale(-1, 1)" : void 0);
    return (r, G) => (t(), e("svg", Z({
      ...
      g(r.$slots, "default"),
      c.value === "bold" ? (t(), e("g", v, f)) : c.value === "duotone" ? (t(), e("g", w, x)) : c.value === "fill" ? (t(), e("g", z, N)) : c.value === "light" ? (t(), e("g", b, P)) : c.value === "regular" ? (t(), e("g", V, $)) : c.value === "thin" ? (t(), e("g", j, D)) : M("", !0)
    ], 16, C));
  }
});
export {
